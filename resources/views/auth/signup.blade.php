                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="{{URL('assets/images/logo.png')}}" width="60px" alt="" srcset="">
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2 text-center">Beautyver</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{route('register.post')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" name="user_type" value="staff" />
                            </div>
                            <div class="mb-3">
